...
const showcases = [
  {
    title: "Login Page",
    description:
      "สำหรับเข้าใช้งานระบบ Zillion ERP",
    image: "/zillion/8.png",
  },
  {
    title: "Total Projects",
    description:
      "สร้างโครงการเพื่อเก็บเอกสารเกี่ยวกับการบริหารงานต่างๆ ภายในองค์กร",
    image: "/zillion/7.png",
  },
  {
    title: "Quotation",
    description:
      "สร้างใบเสนอราคาให้ลูกค้าที่ดึงข้อมูลมากจากโครงการ พร้อมระบบติดตามสถานะการอนุมัติ",
    image: "/zillion/6.png",
  },
  {
    title: "Quotation Details",
    description: "ใช้ข้อมูลสินค้าจาก master ในการสร้างใบเสนอราคา",
    image: "/zillion/5.png",
  },
  {
    title: "Sales Attendance",
    description: "ติดตามสถานะการเข้า-ออกงานของพนักงานขาย",
    image: "/zillion/4.png",
  },
  {
    title: "Installation",
    description: "จัดการงานติดตั้งสินค้า ให้ลูกค้า พร้อมบันทึกข้อมูลหน้างาน",
    image: "/zillion/3.png",
  },
  // {
    ...
    <section className="w-full max-w-9xl mx-auto px-6 py-24">
      ...
      "
        ...
        <div className="lg:col-span-7">
          <div className="relative aspect-[30/19] overflow-hidden rounded-2xl bg-white/5">
